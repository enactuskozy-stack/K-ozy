...
//
//  GET /.netlify/functions/admin-store        → { customers, schools, emails, inventory, flags }
//  PUT /.netlify/functions/admin-store        → { customers:[...], flags:{...} } 형태로 일부만 저장
//
// 전부 관리자 전용이다. 브라우저 localStorage 대신 이 곳에 저장해
